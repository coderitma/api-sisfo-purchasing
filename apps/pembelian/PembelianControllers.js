...
PembelianControllers.post(
  ...
  [
    ...
    PembelianValidators.items.inner.kodeBarang(),
    PembelianValidators.items.inner.namaBarang(),
    PembelianValidators.items.inner.hargaBeli(),
    PembelianValidators.items.inner.jumlahBeli(),
    PembelianValidators.items.inner.subtotal(),
    BaseValidatorRun(),
  ],
  async (req, res) => {
